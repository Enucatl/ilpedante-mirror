---
layout: "post"
title: "Della magica poiesi"
author: "Il Pedante"
date: "2024-07-29 17:30:00"
permalink: "/post/della-magica-poiesi/"
---

Questo articolo è stato ripubblicato nel volume
[Nel Regno della Quantità](https://www.leoneverde.it/prodotto/nel-regno-della-quantita)
edito da Il Leone Verde, Torino.
...
In sé, la moneta è uno strumento per
...
ricaverebbe
*qualora fosse venduto*
, mentre la ricchezza
monetaria corrisponde ai beni che si acquisirebbero
*qualora fosse
spesa*
. Quello
monetario non è
...
allude alla più ampia accezione di valore d’uso
[[3]](#fn:3)
...
toujours exclusivement sur ce qu’il coûte»
[[5]](#fn:5)
.
Questa
...
può essere travalicato senza incorrere in maledizioni e sventure
[[6]](#fn:6)
,
tanto meno ciò
...
l’inviolabilità della «casa di preghiera» (
*οἶκος
προσευχῆς*
),
...
La moneta non è sempre – o almeno non
...
In queste poche pagine non si può
...
vicende materiali e ideali delle civiltà
[[11]](#fn:11)
.
Ci basta qui soffermarci sulle concenzioni attribuite a
**Pitagora**
e
...
prometeiche e le cadute di ogni civiltà del numero
[[12]](#fn:12)
.
Secondo il mito,
**Pitagora**
sarebbe stato il primo ad affermare la
...
presto messa in crisi dal suo allievo
**Ippaso di Metaponto**
, a cui si
...
sua idea è incommensurabile
[[13]](#fn:13)
.

Il sogno razionalistico di comprimere la realtà nell’intelletto
...
esso parte delle sue ragioni. Quando, nel 1623,
**Galileo Galilei**
scriveva ne
*Il Saggiatore*
che il «grandissimo libro» dell’universo può intendersi
solo mediante la «lingua matematica» non faceva altro che tradurre alla lettera il pitagorico
**Filolao**
:
«tutto quel che si conosce ha un numero: senza il numero non sarebbe
possibile ne pensare, né conoscere alcunché».
[[16]](#fn:16)
.
E quando rimetteva in arnese quell’antico sapere applicandogli
l’etichetta all’apparenza più dimessa di «metodo», saltava a
pie’ pari l’incidente di
**Ippaso**
gettando le basi affinché da
un’euristica dallo statuto incerto sorgesse una «metafisica della
quantità» imbracciata da lì in poi da tutti i materialisti.
[[17]](#fn:17)

Ma il terreno era stato preparato da tempo. Se
già più di un secolo e mezzo prima
**Pico della Mirandola**
aveva riproposto l’adagio pitagorico
...
(1509) di
**Luca Pacioli**
leggiamo che «nella Sapientia ancora è scripto quod omnia consistunt
...
sottoposto». La chiusa sorprendente di questo famoso passo («fia
*sottoposto*
») sottende
una rivoluzione. Se infatti
**Filolao**
e i pitagorici «did not believe
that all things are numbers, but rather that all things that are
known are known through number»,
[[20]](#fn:20)
...
gnosi dei cabalisti.
*Il numero è il verbo immanente, la trama di cui
il tutto è tessuto*
».
[[21]](#fn:21)

Da qui è facile scivolare in una gerarchia ontologica: non più la
ricerca del numero nella realtà, ma
*della realtà nel
numero*
, fino appunto a pretendere che la prima «fia sottoposta»
...
[[22]](#fn:22)
Qui il numero non coincide più con la natura (
**Pitagora**
) né vi allude
(
**Platone**
), ma dischiude una realtà di ordine superiore e divino
(
*arithmetica divina*
) secondo un principio che «affonda le sue
...
le quali è strutturata l’intera realtà».
[[23]](#fn:23)
Ciò però implica anche la tentazione oscura di una
*magia
illicita*
[[24]](#fn:24)
che usurpa le prerogative del Creatore per evocare
...
di una poiesi magica nelle mani di un illusionista-demiurgo.

Una siffatta ipotesi sarebbe azzardata se le
...
o sogno. E tutto ciò che i suoi addetti proclamano
*per
numeros*
deve essere vero anche quando non ha
riscontro nell’esperienza – aneddotica, irrilevante, male
interpretata ecc. – degli individui. Similmente, la statistica ha
tradotto l’antica arte sovrana (
*basiliké téchne*
)
in una
*Staatswissenschaft*
governata dai numeri
[[25]](#fn:25)
...
del necessario. Come ha limpidamente osservato
**Nikolas Rose**
, il numero
...
La conferma più chiara e recente di
...
piuttosto il capolinea obbligato di una
*reductio ad numeros*
...
Tornando al nostro tema, la moneta ha non
...
Parrebbe un caso, ma non lo è, che quello stesso frate
**Pacioli**
sia
...
il cui seme gettato da un altro frate dello stesso ordine,
**Pietro di
Giovanni Olivi**
, era stato custodito dai confratelli di Santa Croce a
Firenze.
[[29]](#fn:29)
Nel
...
già asservito a un processo produttivo (
*industria*
), sì che
il suo prestito comportasse un
*lucrum cessans*
lecitamente
...
Più che valutare la bontà e forse l’ineluttabilità di questa
...
*ontologico*
. Secondo la precedente tesi tomistica, se il valore della
...
Il capitale deve i suoi attributi esistenziali e «vitali» ai beni
con cui è scambiato, dunque anche il seme lucrativo riconosciutogli
dall’
**Olivi**
è solo la traslazione impropria di una capacità
creativa che è invece propria degli esseri viventi e del lavoro.
[[33]](#fn:33)
...
anche
il
precetto di non violare i suoi limiti.

Così il credito si fa anche seme
di concetti e corollari morali: la
«credibilità» del
debitore sottoposta a un giudizio (
*rating*
),
la «fiducia»
degli
...
si declinino più a fondo gli sviluppi di questo processo.
...
depositato e scambiato non ha forma fisica.
[[42]](#fn:42)
Eppur tuttavia anche in ciò si confermerebbe la purezza del suo
...
manufatto, o almeno di un’immagine.
...
*dépassement*
, cioè a dire l’invasione della moneta
emancipata nel disertato campo dello spirito. Resasi
*spiritus*
nel
corpo – prima imponderabile come la carta, poi impalpabile come i
byte – essa usurpa dello spirito le qualità metafisiche di
ubiquità, onnipresenza, infinitezza
[[43]](#fn:43)
e anche le sue funzioni di rappresentazione, immaginazione e
giudizio.

Pur elevandosi sopra la natura, essa non può tuttavia
rendersi soprannaturale ma è piuttosto
*preternaturale*
come lo
...
cui il soldo prima aspira a un cambio ascendente di
*genus*
per
...
assoggettare il mondo nel numero, che nella moneta
*dégénérée*
...
l’esercizio del prestito a interesse.
[[47]](#fn:47)
...
prescrizioni dettate da Jahvè nel Levitico,
[[49]](#fn:49)
...
sì
una cosa sacrale, ma proprio
*affinché*
*non diventasse sacra*
,
purché
cioè
le effigi – i numeri,
...
1. Qui si è consultata la
   ...
   *Le
   ...
   , Parigi, 1945.
   [↩](#fnref:1)
2. Le funzioni del denaro riportate nei
   manuali
   di
   economia
   ricalcano, con poche
   ...
   «triade» di
   **John Hicks:**
   1) mezzo di pagamento, 2) unità di conto e misura del
...
3. È valore
   ...
   *complacibilitas*
   ...
   universale.
   [↩](#fnref:3)
4. «Se in un certo momento non abbiamo bisogno di nulla, la moneta è
...
6. Nella
   ...
   (a cura di),
   *Autour
   de la notion de sacer,*
   Publications de l’École française de Rome, Roma, 2017.
   [↩](#fnref:6)
7. «Μὴ ποιεῖτε τὸν
   *οἶκον*
   τοῦ
   ...
   *οἶκον*
   ...
   mantenuta nella Vulgata («Nolite facere
   *domum*
   Patris mei
   *domum*
   negotiationis»), ma non nella trad. CEI 2008 («Non
...
9. Alle
   ...
   *sacra
   faciere*
   : di una sacralizzazione
   in atto.
   [↩](#fnref:9)
10. I pericoli di
    *credere*
    in
    questa convenzione furono particolarmente avvertiti da
    **Ezra Pound**
    :
...
12. Per
    ...
    Zhmud,
    *All is number? Basic doctrine of Pythagoreanism
    reconsidered*
    , in “Phronesis”,
    vol. 34, n. 3, 1989, pp. 270-292.
    [↩](#fnref:12)
13. Sulle circostanze,
    ...
    *Discovery of Incommensurability by Hippasus of Metapontum*
    ...
    (a cura di),
    *Gli Elementi di Euclide e la critica antica e
    moderna (Libro X)*
    , Zanichelli,
    Bologna, 1932.
    [↩](#fnref:13)
14. Più
    di un secolo dopo, Platone faceva dire all’Ateniese de
    *Le leggi*
    che l’ignoranza di questa
    scoperta «non era
...
15. L’episodio
    è narrato
    in uno scolio al Libro X degli
    *Elementi*
    di Euclide attribuito a
    **Proclo Licio Diadoco**
    , che ne dà anche l'interpretazione:
    ...
    *l'inesprimibile e l'inimmaginabile avrebbero dovuto rimanere sempre
    celati*
    ». Ne fa cenno anche
    **Giamblico**
    ...
    **Pitagora**
    .
    [↩](#fnref:15)
16. Framm. B4, in H. Diels, W. Kranz,
    *Die Fragmente der Vorsokratiker*
    ,
    Weidmann, Dublin-Zürich, 1952, Vol. 1, Cap. 47.
    [↩](#fnref:16)
17. A distanza di quasi quattro secoli non si è ancora giunti a una
    ...
    le critiche più recenti, v. P.P. Dal Monte.,
    *La
    favola della scienza,*
    in pubblicazione).
    [↩](#fnref:17)
18. *Conclusiones philosophicae, cabalisticae et theologicae*
    ,
    p. LXXXV
    (1486).
    [↩](#fnref:18)
19. Sap 11,21: «… sed omnia in mensura, et numero et pondere
    disposuisti».
    [↩](#fnref:19)
20. «…
    and number in Philolaus appears in an epistemological but not
    ontological context» (C. A. Huffman,
    *Philolaus of Croton:
...
22. «Le
    ...
    *Conclusiones*
    ...
    comme principe réel,
    *antérieur à la chose materielle*
    (Enn. VI-vi, c. 9)» (L.
    Valcke,
    *Des
    ...
    41, 1, 1985, cit. in F.
    Buzzetta,
    *«Magia naturalis» e «scientia cabalae» in Giovanni Pico della
    Mirandola*
    ,
    Olschki,
    2019).
...
23. F.
    Buzzetta,
    *«Magia
    naturalis» e «scientia cabalae»…*
    , cit.
    [↩](#fnref:23)
24. È stato osservato che la distinzione
    operata
...
25. «Der
    ...
    Staatswissenschaft einzelner Reiche…» (in G. Achenwall,
    *Abriß
    der neuesten Staatswissenschaft der heutigen vornehmsten
    europäischen Reiche und Republiken zum Gebrauch in seinem
    Academischen Vorlesungen*
    , 1749). Giurista e docente a Gottinga,
    **Gottfried Achenwall**
    (1719-1772) è considerato uno dei padri della
    statistica moderna.
    [↩](#fnref:25)
26. N.
    Rose,
...
28. Così
    scrive
    **Jeremy Cripps**
    nella prefazione all’edizione inglese del
    c.d. «Trattato di partita doppia» contenuto nella
    *Summa De
...
30. Mentre
    ...
    in
    sé (v. ad es. le prediche infuocate di
    **San Bernardino
    da Siena**
    ), questa trovò successivamente aperture in
    alcuni esponenti
    della Scuola di Salamanca, v. infra.
    [↩](#fnref:30)
31. Per
    una succintissima panoramica, cfr. L. Barberi,
    *Il capitalismo non
    è un termine evangelico. Una breve riflessione “sturziana”
    rileggendo l’Enciclica Caritas in veritate di Benedetto XVI*
    ,
    in “Stato, Chiese e pluralismo
    confessionale”, 15 ottobre 2012 (
    [link](http://pdnt.link/4279)
    ).
    [↩](#fnref:31)
32. *Summa
    Theologica*
...
37. Oggi
    ...
    cose, così evidentemente la finanza ha impersonato l’economia.
    [↩](#fnref:37)
38. Osserviamo
...
42. Ciò
    ...
    *The
    ...
    , Open
    Court Publishing Mathieu, Chicago, 2000).
    [↩](#fnref:42)
43. Si
    traperò
    di
    ...
    «There are significant properties of bits which make them
    *seem*
    special, namely their ease of
    transport and reproduction» (D. Koepsell,
    *The
    Ontology of Cyberspace*
    ,
    cit.).
...
44. «Il
    ...
    ai Confratelli Esorcisti e Ausiliari, 2014).
    [↩](#fnref:44)
45. Sum.
    Theol., cit.; Sententia libri Politicorum,
    Lib. 1, Lec. 8. In ossequio al testo originale (
    *παρά*
    ) le
